...
Heatmap is widely used method for the visualization of gene expression data. I make heatmap for visualization of log2FC data from multiple samples. This time I decided to write a notebook by breaking down every steps so that it become easier for me too modify this code to produce desired heatmap. The code is taken from the ComplexHeatmap documentation and I added the explanation for each step.
